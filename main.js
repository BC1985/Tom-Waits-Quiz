...
const STORE = [
    ...
    {
        number: 2,
        question: "Which record label released Tom Waits' first album 'Closing Time'?",
    ...
    },
    {
        ...
        answers: ['Pizza maker', 'Auto mechanic', 'Hot dog vendor', 'Construction worker'],
        correctAnswer: 'Pizza maker',
    },
    {
        number: 4,
        question: "Which album marks Tom Waits' shift toward the Avant-garde?",
        answers: ['Mule Variations', 'Big Money', 'Swordfishtrombones', 'Franks Wild Years'],
        correctAnswer: 'Swordfishtrombones',
    },
    {
        number: 5,
        question: 'Which album by Tom Waits won a Grammy in 1992?',
        answers: ['The Black Rider', 'Heart of Saturday Night', 'Real Gone', 'Bone Machine'],
        correctAnswer: 'Bone Machine',
    },
    {
        number: 6,
        question: 'Who directed the film "Down by Law" starring Tom Waits?',
        answers: ['Francis Ford Coppola', 'Martin Scorcese', 'Jim Jarmusch', 'David Lynch'],
    ...
    {
        number: 8,
        question: "In what year was Tom Waits inducted into the Rock'nroll Hall of Fame?",
        answers: ['1979', '1984', '1995', '2011'],
        correctAnswer: '2011',
    },
    {
        number: 9,
        question: 'For which of the following bands did Tom waits open for early in his career?',
        answers: ['Eagles', 'Kansas', 'The Mothers of Invention', 'Steely Dan'],
        correctAnswer: 'The Mothers of Invention',
    },
    {
        number: 10,
        question: 'Which album by Tom Waits was based on the 19th century play "Wozzeck"?',
...
function generateQuestion() {
    ...
    <fieldset>
    <label for='answer1'>
    <input type='button' value='${STORE[questionNumber].answers[0]}' id='answer1' required>
    </label>

    <label for='answer2'>
    <input type='button' value='${STORE[questionNumber].answers[1]}' id='answer2' required>
    </label>

    <label for='answer3'>
    <input type='button' value='${STORE[questionNumber].answers[2]}' id='answer3' required>
    </label>

    <label for='answer4'>
    <input type='button' value='${STORE[questionNumber].answers[3]}' id='answer4' required>
    </label>
...
function restartQuiz() {
    ...
    $('body').css('background-image', "url('https://www.morrisonhotelgallery.com/images/big/Tom%20Waits%20233B%20(3A)II.jpg')")
    $('h1').css('color', 'white');
